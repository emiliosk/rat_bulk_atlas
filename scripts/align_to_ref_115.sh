...
#SBATCH -J align_to_ref_115
#SBATCH -e logs/align_to_ref_115_%j.err
#SBATCH -o logs/align_to_ref_115_%j.out
...
output_dir=$WORK_DIR/local/kallisto_out_115
metadata="$WORK_DIR/metadata/filename_metadata_rat.tsv"
reference_file=$WORK_DIR/local/reference/Rattus_norvegicus.GRCr8.cdna.all.fa.index
